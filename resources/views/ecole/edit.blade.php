		...
		<div class="card">
			...
			<div class="card-body"><p class="text-muted"></p>
				<div class="live-preview"><strong><div class="msgAjouter"></div></strong>
					<form action="{{route('ecole.update',$item->id_eco)}}" method="post" id="form" class="row g-3 needs-validation" novalidate >
						@csrf()
						@method('PATCH')
							<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									{!! Form::text('nom_eco',$item->nom_eco,["id"=>"nom_eco","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Nom" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="sigle_eco" class="form-label">{!!trans('data.sigle_eco')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::text('sigle_eco',$item->sigle_eco,["id"=>"sigle_eco","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Sigle" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="adres_eco" class="form-label">{!!trans('data.adres_eco')!!} </label>
									{!! Form::text('adres_eco',$item->adres_eco,["id"=>"adres_eco","class"=>"form-control"  ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Adresse" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="ville_eco" class="form-label">{!!trans('data.ville_eco')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::text('ville_eco',$item->ville_eco,["id"=>"ville_eco","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Ville" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="CodePos_eco" class="form-label">{!!trans('data.CodePos_eco')!!} </label>
									{!! Form::text('CodePos_eco',$item->CodePos_eco,["id"=>"CodePos_eco","class"=>"form-control"  ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Code postal" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="pays_eco" class="form-label">{!!trans('data.pays_eco')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::text('pays_eco',$item->pays_eco,["id"=>"pays_eco","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Pays" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="tel_eco" class="form-label">{!!trans('data.tel_eco')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::text('tel_eco',$item->tel_eco,["id"=>"tel_eco","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Contact" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="email_eco" class="form-label">{!!trans('data.email_eco')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::text('email_eco',$item->email_eco,["id"=>"email_eco","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer E-mail" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
