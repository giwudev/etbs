...
<div class="modal-content">
    ...
    <div class="modal-body">
        ...
        <form id="formAction" class="needs-validation" novalidate>
            {!! Form::textarea('id_menu', null, [
                'class' => 'form-control',
                'placeholder' => "Entrer la  justificacion de l'absences",
                'autocomplete' => 'off',
            ]) !!}
            @csrf()
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.response == 1) {
                    ...
                    $("#varyingcontentModalLabel").animate({
                        scrollTop: 0
                    }, "fast");
                    $("div.msgAction").html(
                        '<div class="alert alert-success alert-border-left alert-dismissible fade show" role="alert"><i class="ri-notification-off-line me-3 align-middle"></i> <strong>Infos </strong> Suppression réussie. </div>'
                    ).show(200);
                } else {
                    $("div.msgAction").html(
                        '<div class="alert alert-success alert-border-left alert-dismissible fade show" role="alert"><i class="ri-notification-off-line me-3 align-middle"></i> <strong>Infos </strong> Echec de suppression. </div>'
                    ).hide(200);
                }
            },
            errors: function() {
