...
@section('content')
	...
	<div class="col-lg-12">
		<div class="card"  id="ticketsList">
				...
				{!! Form::open(array('id' => 'formSearch','class' => '', 'method' => 'GET')) !!}
					<div class="row gy-4">
						...
						<div class="col-xxl-3 col-md-4"> <!--Code en commentaire a remplacer display:none si l'element est parametre -->
							<?php // echo ((!in_array('combo_appeler,session('InfosAction'))) ? "style='display:none;'" : '')?>
							<div><label for="labelInput" class="form-label">Liste vos programmes</label>
								<?php $addUse = array(''=>'Selectionnez un element'); $listemploi_id = $addUse + $listemploi_id->toArray();?>
			...
			<div class="card-body"><div id='dataRefresh' class="table-responsive table-card mb-4 m-2 giwuRefresh">@include('appeler.index-search')</div></div>
		</div><!--end card-->
	</div><!--end col-->
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			function fetch_page(page){
				...
				$.ajax({ url:"appeler?page="+page, data: dr, type: 'GET',
		...
		function funcRecher(){
			...
			return $.ajax({
				url: '{{ url("/appeler/")}}',data: filtreData,type: 'GET',
