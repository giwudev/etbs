		...
		<div class="card">
			...
			<div class="card-body"><p class="text-muted"></p>
				<div class="live-preview"><strong><div class="msgAjouter"></div></strong>
					<form action="{{route('classe.store')}}" method="post" id="form" class="row g-3 needs-validation" novalidate >
						@csrf()
							<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-3">
									<label for="libelle_clas" class="form-label">{!!trans('data.libelle_clas')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::text('libelle_clas','',["id"=>"libelle_clas","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Classe" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
							...
							<div class="col-12">
								<div class="text-end">
									<a href="{{route('classe.index')}}" class="btn btn-outline-dark waves-effect mr-10">Fermer</a>
