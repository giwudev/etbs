		...
		<div class="card">
			...
			<div class="card-body"><p class="text-muted"></p>
				<div class="live-preview"><strong><div class="msgAjouter"></div></strong>
					<form action="{{route('promotion.update',$item->id_pro)}}" method="post" id="form" class="row g-3 needs-validation" novalidate >
						@csrf()
						@method('PATCH')
							<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									{!! Form::text('libelle_pro',$item->libelle_pro,["id"=>"libelle_pro","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Promotion" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									...
									{!! Form::select('class_id',$listclass_id ,$item->class_id,["id"=>"class_id","class"=>"form-select allselect" ,"required"=>"required"]) !!}
								</div>
							</div>
							<div class="col-12">
								<div class="text-end">
