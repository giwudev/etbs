		...
		<div class="card">
			...
			<div class="card-body"><p class="text-muted"></p>
				<div class="live-preview"><strong><div class="msgAjouter"></div></strong>
					<form action="{{route('discipline.store')}}" method="post" id="form" class="row g-3 needs-validation" novalidate >
						@csrf()
							<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									{!! Form::text('code_disci','',["id"=>"code_disci","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Code" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="libelle_disci" class="form-label">{!!trans('data.libelle_disci')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::text('libelle_disci','',["id"=>"libelle_disci","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Discipline" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
