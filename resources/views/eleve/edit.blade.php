		...
		<div class="card">
			...
			<div class="card-body"><p class="text-muted"></p>
				<div class="live-preview"><strong><div class="msgAjouter"></div></strong>
					<form action="{{route('eleve.update',$item->id_el)}}" method="post" id="form" class="row g-3 needs-validation" novalidate enctype='multipart/form-data'>
						@csrf()
						@method('PATCH')
							<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									{!! Form::text('nom_el',$item->nom_el,["id"=>"nom_el","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Nom" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="prenom_el" class="form-label">{!!trans('data.prenom_el')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::text('prenom_el',$item->prenom_el,["id"=>"prenom_el","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Prenom" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="matricule_el" class="form-label">{!!trans('data.matricule_el')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::text('matricule_el',$item->matricule_el,["id"=>"matricule_el","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Matricule" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="date_nais_el" class="form-label">{!!trans('data.date_nais_el')!!} </label>
									{!! Form::date('date_nais_el',$item->date_nais_el,["id"=>"date_nais_el","class"=>"form-control"  ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Date naissance" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
							...
							<div class="col-md-6">
								<div class="mb-3">
									<label for="photo_el" class="form-label">{!!trans('data.photo_el').' '.$item->photo_el!!} </label>
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									{!! Form::text('tuteur_el',$item->tuteur_el,["id"=>"tuteur_el","class"=>"form-control"  ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Tuteur" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="email_el" class="form-label">{!!trans('data.email_el')!!} </label>
									{!! Form::text('email_el',$item->email_el,["id"=>"email_el","class"=>"form-control"  ,'autocomplete'=>'off' ,'placeholder'=>"Entrer E-mail" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
