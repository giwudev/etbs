                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="statut_trimSem" class="form-label">{!! trans('data.statut_trimSem') !!} <strong
                                            style='color: red;'> *</strong></label>
                                    {!! Form::select('statut_trimSem', trans('entite.statutanne'), null, [
                                        'id' => 'statut_trimSem',
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="date_debut" class="form-label">Date de début<strong style='color: red;'>
                                            *</strong></label>
                                    {!! Form::date('date_debut', null, ['id' => 'date_debut', 'class' => 'form-control', 'required' => 'required']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="date_fin" class="form-label">Date de fin<strong style='color: red;'>
                                            *</strong></label>
                                    {!! Form::date('date_fin', null, ['id' => 'date_fin', 'class' => 'form-control', 'required' => 'required']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
