		...
		<div class="card">
			...
			<div class="card-body"><p class="text-muted"></p>
				<div class="live-preview"><strong><div class="msgAjouter"></div></strong>
					<form action="{{route('trimsem.update',$item->id_trimSem)}}" method="post" id="form" class="row g-3 needs-validation" novalidate >
						@csrf()
						@method('PATCH')
							<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									{!! Form::text('libelle_trimSem',$item->libelle_trimSem,["id"=>"libelle_trimSem","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Libelle" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="statut_trimSem" class="form-label">{!!trans('data.statut_trimSem')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::select('statut_trimSem',trans('entite.statutanne') ,$item->statut_trimSem,["id"=>"statut_trimSem","class"=>"form-select allselect" ,"required"=>"required"]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
